...
function LocationSearch() {
  ...
  return (
    ...
    <div
      ...
      >
      <div className="LocaSearch_selects">
        <select onChange={sidoSelect}>
          <option>시,도</option>
          {sido.map((e, idx) => (
      ...
      <div style={{ width: "80%", height: "700px", borderRadius: "10px" }}>
        <KakaoMap />
      </div>
    </div>
          </div>
